...
export class smartGridPanel extends Smart.Component {
    get name() {
        return 'smartGridPanel';
    }	
}

export class smartSortPanel extends Smart.Component {
    get name() {
        return 'smartSortPanel';
    }
}

export class smartGroupPanel extends Smart.Component {
    get name() {
        return 'smartGroupPanel';
    }
}

export class smartMultiColumnFilterPanel extends Smart.Component {
    get name() {
        return 'smartMultiColumnFilterPanel';
    }
}

export class smartColumnPanel extends Smart.Component {
    get name() {
